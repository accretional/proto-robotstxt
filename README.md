...
Later we'll add tooling for generating robots.txt files, modifying, etc. For now create a gen/ with the built binaries and protos gitignored, except for a single consolidated proto/rep.proto once ready. Create a cmd/gluon to demonstrate/test out the derived format.
...
In general prefer to test against accretional.com/robots.txt
