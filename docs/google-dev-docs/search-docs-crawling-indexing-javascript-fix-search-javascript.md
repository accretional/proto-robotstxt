<!--
  ...
  Fetched: 2026-07-04T06:23:10Z by tools/google-dev/pull-docs.sh
...
- To test how Google crawls and renders a URL, use the Rich Results Test or the URL Inspection Tool in Search Console. You can see loaded resources, JavaScript console output and exceptions, rendered DOM, and more information.
...
- Make sure your web components render as expected. Use the Rich Results Test or the URL Inspection Tool to check if the rendered HTML has all content you expect.
